function rankOverall(bookID) {
  ...
  // 6. Lock the sheets now that everything is finished
  lockSheetForAutomation(sh);
  lockSheetForAutomation(configSh);
